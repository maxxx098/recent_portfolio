      ...
      <div id="menu-target" data-scroll-container ref={refScroll}>
        <Head>
          ...
          <meta
            ...
            content="#10101A"
          />
          <title>Symon Falcatan 🚀 &mdash; Full Stack Web Devloper</title>
          <meta
            name="description"
        ...
        <main className="container">
          <p className="about-text">
            Hello stranger! 👋, my name is Symon and I am a Full Stack Web Developer,
          ...
          <section id="sectionProjects" className="section-projects">
            ...
            <div className="project-card">
              <div className="project-card__left">
                <h4 className="heading-4">
                  NEXT JS, APPWRITE, REACT JS, JAVASCRIPT, NODE JS, TYPESCRIPT, TAILWIND
                </h4>
              </div>
              <div
              ...
              >
                <img src="webp/healthcare.webp" alt="alexxandria model" />
                <img src="webp/healthecare_banner.webp" alt="alexxandria logo" />
              </div>
            ...
            <div className="project-card">
              <div className="project-card__left">
                <h4 className="heading-4">NODE JS, APPWRITE, TAILWIND, TYPESCRIPT</h4>
              </div>
              <div
                className="project-card__middle"
                data-displacement="webp/myDistorsionImage.webp"
              >
                ...
                <img src="png/snapgram_app.png" alt="safarika logo" />
              </div>
              <div className="project-card__right">
                <h2
                  data-scroll
            ...
            <div className="project-card">
              <div className="project-card__left">
                <h4 className="heading-4">
                 SOLIDITY, VITE JS, SMART CONTRACT, CRYPTO
                </h4>
              </div>
              <div
                className="project-card__middle"
                data-displacement="webp/myDistorsionImage.webp"
              >
                <img src="png/blockchain_web.png" alt="heatrow" />
                <img src="png/blockchain_web_cover.png" alt="heatrow logo" />
              </div>
              <div className="project-card__right">
                <h2
                  data-scroll
            ...
            <div className="project-card">
              <div className="project-card__left">
                <h4 className="heading-4">HTML, SCSS, JAVASCRIPT, ANIMATION CSS, PHP, LARAVEL</h4>
              </div>
              <div
                className="project-card__middle"
                data-displacement="webp/myDistorsionImage.webp"
              >
                <img src="png/HotelManagement.png" alt="adeola model" />
                <img src="png/Hotel_cover.png" alt="adeola logo" />
              </div>
              <div className="project-card__right">
                <h2
                  data-scroll
                ...
                <a
                  rel="noopener"
                  target="_blank"
                  href="https://youtu.be/t_38uvD1OlM"
                  className="project-card__link"
                >
                 VISIT THE WEBSITE
                </a>
